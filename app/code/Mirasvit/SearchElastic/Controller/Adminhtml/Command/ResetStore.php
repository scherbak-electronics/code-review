...
class ResetStore extends Command
{
    ...
    public function execute()
    {
        ...
        try {
            $this->manager->resetStore($note);
            $message .= __('Store indexes available for current Elasticsearch connection are deleted successfully. Products are unavailable on your frontend now.
