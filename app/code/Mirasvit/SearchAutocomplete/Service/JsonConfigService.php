...
class JsonConfigService
{
    ...
    /**
     * @var JsonAdvancedOptionsService
     */
    ...
    private function generateAutocompleteConfig()
    {
        $config = [
            ...
            'textAll'                   => $this->getStoreSpecificText('Show all %d results →', null, "%d"),
            'textEmpty'                 => $this->getStoreSpecificText('Sorry, nothing found for "%s".', null, "%s"),
     ...
     * @return string
     */
    private function getEmulatedStoreText($sampleText, $storeId, $parameter = null)
    {
