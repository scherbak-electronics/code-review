...
class Content extends \Magento\Backend\Block\Widget
{
    ...
    {
        $imageUploadConfigDataProvider = new \Magento\Framework\DataObject();
        $imageUploadConfigDataProvider->setIsResizeEnabled(true);
        $this->addChild(
            'uploader',
        ...
        $this->getUploader()->getConfig()->setUrl(
			...
			$this->_urlBuilder->getUrl('slideshow/slideshow_gallery/upload')
        )->setFileField(
            'image'
        )->setFilters(
            [
