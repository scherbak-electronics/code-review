...
define([
        ...
        openDialog: function(btn, url, width, height, title, options) {
            ...
            if (!this.modal) {
                ...
                $.ajax({
                    ...
                    self.modal.html(data.replace('"mediabrowser"','"Codazon_Shopbybrandpro/js/browser"')).trigger('contentUpdated');
                });
            } else {
                this.modal.modal('openModal');
            }
    ...
    $.widget("custom.cdzMediabrowser", {
        eventPrefix: "cdzMediabrowser",
        options: {
        ...
        insert: function(event) {
            ...
            if (!targetEl.length) {
                CdzMediabrowserUtility.closeDialog();
            ...
            return $.ajax({
                ...
                data: {
                    ...
                    as_is: targetEl.is('textarea') ? 1 : 1,
                    form_key: FORM_KEY
                },
                context: this,
                showLoader: true
                ...
                if (typeof data == 'string') {
                    ...
                    data.full = Codazon.mediaUrl + data.short;
                }
        ...
        getTargetElement: function() {
            if (typeof CdzMediabrowserUtility.targetElement !== 'undefined') {
                return CdzMediabrowserUtility.targetElement;
            } else {
