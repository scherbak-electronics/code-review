...
class CustomCanonical extends AbstractDb
{
     ...
     * @var int|null
     */
    protected $canonicalStoreId = null;
     ...
     */
    public function getUrl($customCanonical, $currentStoreId, &$canonicalStoreId = null, $isGraphQl = false)
    {
        ...
        if (!empty($url)) {
            return ($isGraphQl) ? $url : $this->helperStoreUrl->getUrl($url, $storeId);
        }
