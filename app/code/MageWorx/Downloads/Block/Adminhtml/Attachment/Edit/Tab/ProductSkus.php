...
class ProductSkus extends GenericForm implements TabInterface
{
    /**
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField(
            ...
            [
                ...
                'note'  => __(
                    'To enter a new product SKU, either start a new line'
