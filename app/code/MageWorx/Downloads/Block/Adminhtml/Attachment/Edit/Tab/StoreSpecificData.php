...
class StoreSpecificData extends GenericForm implements TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        if ($attachment->getStoreLocales()) {
            $storeLocales = $this->convertDataForForm($attachment->getStoreLocales());
    ...
    protected function createStoreSpecificFieldsets($form)
    {
        ...
        foreach ($stores as $store) {
            ...
            $fieldset->addField(
                'store_attachment_name_' . $storeId,
                'text',
                [
                    'name'     => 'store_attachment_names[' . $storeId . ']',
                    'label'    => __('Name'),
                    'title'    => __('Name'),
                    'required' => false,
                ]
            ...
            $fieldset->addField(
                'store_attachment_description_' . $storeId,
                'editor',
                [
                    'name'                => 'store_attachment_descriptions[' . $storeId . ']',
    ...
    {
        return $this->_coreRegistry->registry('mageworx_downloads_attachment');
    }
}
