...
class AttachmentActions extends \Magento\Ui\Component\Listing\Columns\Column
{
     ...
     * @var string
     */
    const URL_PATH_EDIT = 'mageworx_downloads/attachment/edit';
     ...
     * @var string
     */
    const URL_PATH_DELETE = 'mageworx_downloads/attachment/delete';
            ...
            $item[$this->getData('name')] = [
                ...
                'delete' => [
                    ...
                    'confirm' => [
                        ...
                        'message'       => __('Are you sure you want to delete the Attachment "${ $.$data.name }" ?'),
