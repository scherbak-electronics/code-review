...
namespace Magetop\GeoIP\Controller\Adminhtml\System\Config;
...
/**
 * Class Geoip
 * @package Magetop\GeoIP\Controller\Adminhtml\System\Config
 */
class Geoip extends Action
{
    ...
    public function execute()
    {
        $status = false;
        try {
            $path = $this->_directoryList->getPath('var') . '/Magetop/GeoIp/GeoIp';
            if (!file_exists($path)) {
