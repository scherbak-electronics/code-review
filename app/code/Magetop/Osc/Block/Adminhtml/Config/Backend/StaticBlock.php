...
namespace Magetop\Osc\Block\Adminhtml\Config\Backend;
...
use Magetop\Osc\Model\System\Config\Source\StaticBlockPosition;

/**
 * Class StaticBlock
 * @package Magetop\AbandonedCart\Block\Adminhtml\Config\Backend
 */
class StaticBlock extends AbstractFieldArray
{
    ...
    public function _construct()
    {
        ...
        $this->addColumn(
            'sort_order',
            ['label' => __('Sort Order'), 'style' => 'width: 100px', 'class' => 'validate-zero-or-greater']
        );
