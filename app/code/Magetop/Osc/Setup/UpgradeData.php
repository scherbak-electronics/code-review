...
class UpgradeData implements UpgradeDataInterface
{
            ...
            <div class="osc-trust-seals" style="text-align: center;">
                <div class="trust-seals-badges">
                    <a href="https://en.wikipedia.org/wiki/Trust_seal" target="_blank">
                        <img src="{{view url=Magetop_Osc/css/images/seal.png}}">
                    </a>
                </div>
    ...
    private function copyDefaultSeal()
    {
        try {
            ...
            $mediaDirectory->create('magetop/osc/seal/default');
            $targetPath = $mediaDirectory->getAbsolutePath('magetop/osc/seal/default/seal.png');
