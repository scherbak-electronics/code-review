...
class Address extends Data
{
    ...
    {
        if (!$this->getConfigGeneral('geoip') || !$this->isModuleOutputEnabled('Magetop_GeoIP')) {
            return false;
        }
    ...
    /**
     * @return \Magetop\GeoIP\Helper\Address
     */
    protected function getGeoIPHelper()
    {
        return $this->getObject(\Magetop\GeoIP\Helper\Address::class);
    }
