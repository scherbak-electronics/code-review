...
use Magetop\Osc\Helper\AbstractData;
use Magetop\Osc\Model\System\Config\Source\ComponentPosition;
use Zend_Serializer_Exception;

/**
 * Class Data
 * @package Magetop\Osc\Helper
 */
class Data extends AbstractData
{
    ...
    const CUSTOMER_ATTR_URL = 'https://www.magetop.com/magento-2-customer-attributes/' . self::UTM_PARAMS;
    const ORDER_ATTR_URL = 'https://www.magetop.com/magento-2-order-attributes/' . self::UTM_PARAMS;
    ...
    {
        return $this->encryptor->decrypt($this->getConfigGeneral('google_api_key', $store));
    }
    ...
    {
        return 'Magetop_Osc/' . $this->getDesignConfig('page_layout', $store);
    }
     ...
     * @return mixed
     */
    public function getShowCustomerGrid()
    {
    ...
    {
        return $this->isModuleOutputEnabled('Magetop_CustomerAttributes');
    }
    ...
    {
        return $this->isModuleOutputEnabled('Magetop_OrderAttributes');
    }
