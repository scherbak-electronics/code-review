    ...
    $.widget('magetop.survey', {
        ...
        addNewAnswer: function () {
            ...
            if (newAnswer.length > 0) {
                var d = new Date();
                $('<div class="survey-answer"><div class="checkbox-survey"><input type="checkbox" value="_' + d.getTime() + ' " checked/></div><div class="option-value"><span id="other-answer"></span></div><span id="remove-answer">X</span></div>').insertBefore(".option-survey-new");
