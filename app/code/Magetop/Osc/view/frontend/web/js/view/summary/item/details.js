...
define([
    ...
    'Magetop_Osc/js/action/update-item',
    'Magetop_Osc/js/action/gift-message-item',
    'mage/url',
    'mage/translate',
    'Magento_Ui/js/modal/modal',
    'Magetop_Osc/js/action/payment-total-information',
    'Magetop_Osc/js/options/configurable',
    'priceOptions'
    ...
    return Component.extend({
        defaults: {
            template: 'Magetop_Osc/container/summary/item/details'
        },
