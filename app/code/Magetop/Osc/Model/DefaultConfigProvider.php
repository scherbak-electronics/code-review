...
use Magetop\Osc\Model\System\Config\Source\AllowGuestCheckout;
...
class DefaultConfigProvider implements ConfigProviderInterface
{
    ...
    public function getConfig()
    {
        ...
        $output = [
            ...
            'checkVersion242'       => $this->_oscHelper->versionCompare('2.4.2')
        ];
    ...
    private function getShippingMethods()
    {
        ...
        if ($quote->getShippingAddress()->getCountryId()) {
            $methodLists = $this->shippingMethodManagement->getList($quote->getId());
    ...
    {
        return $this->moduleManager->isOutputEnabled('Magetop_SocialLogin')
