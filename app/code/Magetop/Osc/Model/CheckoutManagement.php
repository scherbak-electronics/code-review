...
use Magetop\Osc\Helper\Item as OscHelper;
...
class CheckoutManagement implements CheckoutManagementInterface
{
    ...
    public function getResponseData(Quote $quote)
    {
        ...
        $oscDetails
            ->setImageData($this->oscHelper->jsonEncodeData($imageData))
            ->setOptions($this->oscHelper->jsonEncodeData($optionsData))
            ->setRequestPath($this->oscHelper->jsonEncodeData($requestPath));
