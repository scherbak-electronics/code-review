...
namespace Magetop\Osc\Test\Unit\Helper;
...
/**
 * Class AddressTest
 * @package Magetop\Osc\Test\Unit\Helper
 */
class AddressTest extends TestCase
{
    ...
    public function testGetGeoIPDataWithException()
    {
        ...
        $helperGeoIP = $this->getMockBuilder(\Magetop\GeoIP\Helper\Address::class)
        ...
        $this->objectManagerMock->expects($this->at(1))
            ->method('get')
            ->with(\Magetop\GeoIP\Helper\Address::class)
